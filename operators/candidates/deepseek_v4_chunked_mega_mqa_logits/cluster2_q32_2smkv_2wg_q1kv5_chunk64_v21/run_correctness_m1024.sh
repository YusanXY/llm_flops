...
CANDIDATE="$REPO/operators/candidates/deepseek_v4_chunked_mega_mqa_logits/cluster2_q32_2smkv_2wg_q1kv5_chunk64_v21"
...
flock -w7200 /tmp/mega-mqa-gpu3.lock bash -lc "
    ...
    export MEGA_V21_VERBOSE_BUILD=1
    ./bench.sh run \
      --suite full \
      --mode correctness \
      --operator deepseek_v4_chunked_mega_mqa_logits \
      --candidate cluster2_q32_2smkv_2wg_q1kv5_chunk64_v21 \
