"""V21: two-CTA cta_group::2 Q32 with pipelined Q-pair epilogues.
...
_BUILD = _HERE / ".build_cluster2_q32_2smkv_2wg_q1kv5_chunk64_v21"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_cluster2_q32_2smkv_2wg_q1kv5_chunk64_v21",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V21_VERBOSE_BUILD", "0") == "1",
)
