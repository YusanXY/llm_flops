"""Single-call NCU/NSYS capture harness for canonical single-request V2."""
...
CANDIDATE = (
    ROOT
    / "operators/candidates/deepseek_v4_chunked_mega_mqa_logits/blockq4_nogriddep_q1kv5_v9"
)
...
def main() -> None:
    ...
    spec_module = load("v2_single_request_profile_spec", REFERENCE / "spec.py")
    implementation = load(
        "v9_single_request_profile_impl", CANDIDATE / "implementation.py"
    )
    case = next(
    ...
    if args_cli.capture:
        ...
        torch.cuda.nvtx.range_push(
            f"blockq4_nogriddep_q1kv5_v9_m{args_cli.m}_ctx65536"
        )
    ...
    report = {
        ...
        "profile_range": f"blockq4_nogriddep_q1kv5_v9_m{args_cli.m}_ctx65536",
    }
