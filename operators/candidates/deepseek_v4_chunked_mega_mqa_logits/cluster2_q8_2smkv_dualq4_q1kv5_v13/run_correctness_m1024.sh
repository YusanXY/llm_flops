...
CANDIDATE="$REPO/operators/candidates/deepseek_v4_chunked_mega_mqa_logits/cluster2_q8_2smkv_dualq4_q1kv5_v13"
...
flock -w7200 /tmp/mega-mqa-gpu3.lock bash -lc "
    ...
    export MEGA_V13_VERBOSE_BUILD=1
    ./bench.sh run \
      --suite full \
      --mode correctness \
      --operator deepseek_v4_chunked_mega_mqa_logits \
      --candidate cluster2_q8_2smkv_dualq4_q1kv5_v13 \
