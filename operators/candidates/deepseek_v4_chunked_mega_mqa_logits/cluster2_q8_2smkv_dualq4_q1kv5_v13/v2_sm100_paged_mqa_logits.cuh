...
struct SM100PagedMQALogitsScheduler : SM100IndicesStorage<kIsVarlen> {
    ...
    // The public DeepGEMM path uses N=128/H, which is two queries for
    // H=64.  This candidate deliberately issues a legal SM100
    // cta_group::1 M128N256 TCGen05 tile so one KV traversal serves four
    // adjacent queries.
    ...
    uint32_t cur_request_q_token_start; // request base for Q8 weights/output
