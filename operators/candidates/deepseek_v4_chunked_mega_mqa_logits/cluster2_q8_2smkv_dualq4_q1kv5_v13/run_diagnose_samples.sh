...
flock -w7200 /tmp/mega-mqa-gpu3.lock bash -lc '
    ...
    /home/gjy/data/agent4kernel/mega_mqa_logits/llm_flops/.runtime/venv/bin/python \
      operators/candidates/deepseek_v4_chunked_mega_mqa_logits/cluster2_q8_2smkv_dualq4_q1kv5_v13/diagnose_samples.py
'
