"""V25: V23 with consumers waiting directly on TMEM completion.
...
* math consumers rely on the causal KV-TMA -> UMMA -> full-TMEM chain instead
  of serially waiting both the KV and TMEM barriers;
...
_BUILD = _HERE / ".build_cluster2_q16_2smkv_2wg_q1kv4_directtmem_v25"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_cluster2_q16_2smkv_2wg_q1kv4_directtmem_v25",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V25_VERBOSE_BUILD", "0") == "1",
)
