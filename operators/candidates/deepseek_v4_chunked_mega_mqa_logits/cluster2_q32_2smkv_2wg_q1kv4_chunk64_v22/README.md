# Cluster2 Q32 2SM-KV / two-warpgroup Q1-KV4 chunk64 V22

V22 doubles the validated V17 query-reuse window.  A two-CTA cluster owns
...
Compared with V21, the longer compute interval now uses four rather than five
KV ring stages.  This removes 16,896 bytes of dynamic SMEM per CTA while
retaining enough producer lead distance for eight MMA/epilogue passes.
