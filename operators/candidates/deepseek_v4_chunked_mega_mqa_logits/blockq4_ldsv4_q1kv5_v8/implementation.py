"""V8: V4 with explicit vector shared-memory weight loads.
...
* four adjacent FP32 weights are fetched by one explicit
  ``ld.shared.v4.b32`` instruction per reduction step;
...
_BUILD = _HERE / ".build_blockq4_ldsv4_q1kv5_v8"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_blockq4_ldsv4_q1kv5_v8",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V8_VERBOSE_BUILD", "0") == "1",
)
