...
CANDIDATE="$REPO/operators/candidates/deepseek_v4_chunked_mega_mqa_logits/blockq4_ldsv4_q1kv5_v8"
...
flock -w7200 /tmp/mega-mqa-gpu3.lock bash -lc "
    ...
    export MEGA_V8_VERBOSE_BUILD=1
    ./bench.sh run \
      --suite full \
      --mode correctness \
      --operator deepseek_v4_chunked_mega_mqa_logits \
      --candidate blockq4_ldsv4_q1kv5_v8 \
