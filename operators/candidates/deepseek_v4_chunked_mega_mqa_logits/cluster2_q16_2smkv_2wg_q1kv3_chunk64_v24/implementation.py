"""V24: V23 Q16/chunk64 with a three-stage KV ring.
...
* one Q and three KV shared-memory stages reduce the V23 SMEM footprint by
  another 16,896 bytes per CTA while leaving the math schedule unchanged;
...
_BUILD = _HERE / ".build_cluster2_q16_2smkv_2wg_q1kv3_chunk64_v24"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_cluster2_q16_2smkv_2wg_q1kv3_chunk64_v24",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V24_VERBOSE_BUILD", "0") == "1",
)
