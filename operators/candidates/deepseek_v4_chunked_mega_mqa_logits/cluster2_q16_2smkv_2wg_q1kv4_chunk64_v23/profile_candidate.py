"""Single-call NCU/NSYS harness for the V23 Q16/KV4 two-SM kernel."""
...
CANDIDATE = (
    ROOT
    / "operators/candidates/deepseek_v4_chunked_mega_mqa_logits/cluster2_q16_2smkv_2wg_q1kv4_chunk64_v23"
)
...
def main() -> None:
    ...
    spec_module = load("v23_single_request_profile_spec", REFERENCE / "spec.py")
    implementation = load(
        "v23_single_request_profile_impl", CANDIDATE / "implementation.py"
    )
    case = next(
    ...
    if args_cli.capture:
        ...
        torch.cuda.nvtx.range_push(
            f"cluster2_q16_2smkv_2wg_q1kv4_chunk64_v23_m{args_cli.m}_ctx65536"
        )
    ...
    report = {
        ...
        "profile_range": f"cluster2_q16_2smkv_2wg_q1kv4_chunk64_v23_m{args_cli.m}_ctx65536",
    }
