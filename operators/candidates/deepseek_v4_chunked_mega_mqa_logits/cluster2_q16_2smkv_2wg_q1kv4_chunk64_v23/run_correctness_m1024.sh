...
CANDIDATE="$REPO/operators/candidates/deepseek_v4_chunked_mega_mqa_logits/cluster2_q16_2smkv_2wg_q1kv4_chunk64_v23"
...
flock -w7200 /tmp/mega-mqa-gpu3.lock bash -lc "
    ...
    export MEGA_V23_VERBOSE_BUILD=1
    ./bench.sh run \
      --suite full \
      --mode correctness \
      --operator deepseek_v4_chunked_mega_mqa_logits \
      --candidate cluster2_q16_2smkv_2wg_q1kv4_chunk64_v23 \
