...
CANDIDATE = (
    ROOT
    / "operators/candidates/deepseek_v4_chunked_mega_mqa_logits/blockq4_q1kv5_v4"
)
...
def main() -> None:
    ...
    implementation = load(
        "v4_single_request_profile_impl", CANDIDATE / "implementation.py"
    )
    case = next(
    ...
    if args_cli.capture:
        ...
        torch.cuda.nvtx.range_push(
            f"blockq4_q1kv5_v4_m{args_cli.m}_ctx65536"
        )
    ...
    report = {
        ...
        "profile_range": f"blockq4_q1kv5_v4_m{args_cli.m}_ctx65536",
    }
