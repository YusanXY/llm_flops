"""V2: four-query SM100 MQA tile with a two-stage TMEM ring.
...
_BUILD = _HERE / ".build_blockq4_tmem2"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_blockq4_tmem2_v2",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V2_VERBOSE_BUILD", "0") == "1",
)
