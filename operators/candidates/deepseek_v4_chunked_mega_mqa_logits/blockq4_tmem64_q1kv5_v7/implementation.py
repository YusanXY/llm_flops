"""V7: V4 with one native 64-register TMEM load per H64 result.
...
* each H64 result uses one 32dp32b64x TMEM load plus one fence instead of two
  32-register loads and two fences;
...
_BUILD = _HERE / ".build_blockq4_tmem64_q1kv5_v7"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_blockq4_tmem64_q1kv5_v7",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V7_VERBOSE_BUILD", "0") == "1",
)
