...
CANDIDATE = (
    ROOT
    / "operators/candidates/deepseek_v4_chunked_mega_mqa_logits/blockq8_n256x2_q1kv8_v6"
)
...
def main() -> None:
    ...
    implementation = load(
        "v6_single_request_profile_impl", CANDIDATE / "implementation.py"
    )
    case = next(
    ...
    if args_cli.capture:
        ...
        torch.cuda.nvtx.range_push(
            f"blockq8_n256x2_q1kv8_v6_m{args_cli.m}_ctx65536"
        )
    ...
    report = {
        ...
        "profile_range": f"blockq8_n256x2_q1kv8_v6_m{args_cli.m}_ctx65536",
    }
