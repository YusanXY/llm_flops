...
struct SM100PagedMQALogitsScheduler : SM100IndicesStorage<kIsVarlen> {
    ...
    // Eight adjacent queries share each physical KV traversal.  The compute
    // core covers the resulting N=512 logical tile with two legal
    // cta_group::1 M128N256 TCGen05 instructions.
