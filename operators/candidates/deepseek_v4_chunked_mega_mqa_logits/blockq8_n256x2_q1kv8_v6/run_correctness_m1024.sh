...
CANDIDATE="$REPO/operators/candidates/deepseek_v4_chunked_mega_mqa_logits/blockq8_n256x2_q1kv8_v6"
...
flock -w7200 /tmp/mega-mqa-gpu3.lock bash -lc "
    ...
    export MEGA_V6_VERBOSE_BUILD=1
    ./bench.sh run \
      --suite full \
      --mode correctness \
      --operator deepseek_v4_chunked_mega_mqa_logits \
      --candidate blockq8_n256x2_q1kv8_v6 \
