"""V17: two-CTA cta_group::2 Q16 with pipelined Q-pair epilogues.
...
_BUILD = _HERE / ".build_cluster2_q16_2smkv_2wg_q1kv5_chunk64_v17"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_cluster2_q16_2smkv_2wg_q1kv5_chunk64_v17",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V17_VERBOSE_BUILD", "0") == "1",
)
