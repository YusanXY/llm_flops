...
CANDIDATE = (
    ROOT
    / "operators/candidates/deepseek_v4_chunked_mega_mqa_logits/blockq4_smemweights_v3"
)
...
def main() -> None:
    ...
    implementation = load(
        "v3_single_request_profile_impl", CANDIDATE / "implementation.py"
    )
    case = next(
    ...
    if args_cli.capture:
        ...
        torch.cuda.nvtx.range_push(
            f"blockq4_smemweights_v3_m{args_cli.m}_ctx65536"
        )
    ...
    report = {
        ...
        "profile_range": f"blockq4_smemweights_v3_m{args_cli.m}_ctx65536",
    }
