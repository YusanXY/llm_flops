"""V3: four-query SM100 MQA tile with explicit shared-weight broadcasts.
...
* two Q and four KV shared-memory stages fit below the SM100 dynamic-SMEM
  limit while retaining producer/consumer overlap;
...
_BUILD = _HERE / ".build_blockq4_smemweights_v3"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_blockq4_smemweights_v3",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V3_VERBOSE_BUILD", "0") == "1",
)
