"""Single-call NCU/NSYS harness for the V14 two-warpgroup 2-SM kernel."""
...
CANDIDATE = (
    ROOT
    / "operators/candidates/deepseek_v4_chunked_mega_mqa_logits/cluster2_q8_2smkv_2wg_q1kv5_v14"
)
...
def main() -> None:
    ...
    spec_module = load("v14_single_request_profile_spec", REFERENCE / "spec.py")
    implementation = load(
        "v14_single_request_profile_impl", CANDIDATE / "implementation.py"
    )
    case = next(
    ...
    if args_cli.capture:
        ...
        torch.cuda.nvtx.range_push(
            f"cluster2_q8_2smkv_2wg_q1kv5_v14_m{args_cli.m}_ctx65536"
        )
    ...
    report = {
        ...
        "profile_range": f"cluster2_q8_2smkv_2wg_q1kv5_v14_m{args_cli.m}_ctx65536",
    }
