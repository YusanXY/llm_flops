"""V14: two-CTA cta_group::2 Q8 with parallel Q-pair epilogues.
...
* two math warpgroups consume the two N256 passes in parallel, reducing the
  live register set and restoring the V4-style 384-thread issue footprint;
...
_BUILD = _HERE / ".build_cluster2_q8_2smkv_2wg_q1kv5_v14"
_BUILD.mkdir(exist_ok=True)

os.environ.setdefault("TORCH_CUDA_ARCH_LIST", "10.0a")

_ext = load(
    name="mega_chunked_mqa_cluster2_q8_2smkv_2wg_q1kv5_v14",
    ...
    with_cuda=True,
    verbose=os.environ.get("MEGA_V14_VERBOSE_BUILD", "0") == "1",
)
