"""Single-call capture harness for the full-KV-reuse baseline."""
...
def main() -> None:
    ...
    spec_module = load("full_reuse_profile_spec", REFERENCE / "spec.py")
    implementation = load(
        "full_reuse_profile_impl", REFERENCE / "implementation.py"
    )
    case = next(
    ...
    if args_cli.capture:
        ...
        torch.cuda.nvtx.range_push(
            f"full_kv_reuse_mqa_m{args_cli.m}_ctx65536"
        )
    ...
    report = {
        ...
        "profile_range": f"full_kv_reuse_mqa_m{args_cli.m}_ctx65536",
    }
