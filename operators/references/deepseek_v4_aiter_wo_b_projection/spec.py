"""Contract for the DeepSeek V4 WO_B attention-output projection on MI300X."""
...
def _representative_cases():
    ...
    for m in PREFILL_M:
        ...
        cases.append(
            CaseSpec(
                f"prefill_wo_b_projection_m{m}_context65536",
                {
                    "phase": "prefill",
                    "m": m,
                    "k": K,
    ...
    for m in DECODE_M:
        ...
        cases.append(
            CaseSpec(
                f"decode_wo_b_projection_m{m}_context65536",
                {
                    "phase": "decode",
                    "m": m,
                    "k": K,
...
class DeepSeekV4AiterWoBProjectionSpec:
    operator_id = "deepseek_v4_aiter_wo_b_projection"
    ...
    def make_inputs(self, case, context):
        ...
        if generator is None:
            raise RuntimeError("WO_B projection requires a GPU generator")
        x = torch.randn(
    ...
    def comparator(self, case):
        return OracleStateComparator(
            ...
            name="sglang_aiter_wo_b_projection_oracle",
        )
...
SPEC = DeepSeekV4AiterWoBProjectionSpec()
